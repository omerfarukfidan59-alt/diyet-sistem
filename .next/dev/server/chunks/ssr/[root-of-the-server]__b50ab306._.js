...
function RegisterPage() {
    ...
    const handleRegister = async (e)=>{
        ...
        const { data: authData, error: authError } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.signUp({
            email: systemEmail,
        ...
        if (authData.user) {
            ...
            const { error: profileError } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('profiles').insert([
                {
                    id: authData.user.id,
                    role: "client",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b50ab306._.js.map