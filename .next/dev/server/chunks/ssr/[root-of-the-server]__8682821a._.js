...
function FoodLibrary() {
    ...
    const fetchFoods = async ()=>{
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('food_library').select('*').order('name', {
            ascending: true
        });
        if (error) {
    ...
    const handleSave = async ()=>{
        ...
        if (editId) {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('food_library').update(foodData).eq('id', editId);
            if (error) alert("Güncelleme hatası: " + error.message);
        } else {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('food_library').insert([
                foodData
            ]);
    ...
    const handleDelete = async (id)=>{
        if (window.confirm("Bu besini silmek istediğinize emin misiniz?")) {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('food_library').delete().eq('id', id);
            if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8682821a._.js.map